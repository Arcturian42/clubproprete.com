-- ============================================================================
-- ClubProprete.com — APPLY ALL (Phase 0) — schéma + RLS + RPC concaténés.
-- Fichier de convenance pour l'éditeur SQL Supabase : coller CE fichier entier
-- dans une nouvelle requête et exécuter. Généré depuis migrations/0001+0002+0003.
-- Validé : 21/21 pgTAP + RPC + seed 200/80/50 (Postgres 16 + PostGIS + pgTAP).
-- ============================================================================
